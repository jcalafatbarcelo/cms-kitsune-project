...
`.agents/skills/adr-generator/templates/plantilla_ADR.md`. Este `SKILL.md` define el
...
1. Leer `AGENTS.md`, `docs/context/SDD_Inicial.md`, Specs afectadas y ADR existentes
   en `docs/adr/`.
...
7. Ejecutar la validación estructural antes de terminar:
   ...
   ```bash
   python3 .agents/skills/adr-generator/scripts/validate_adr.py docs/adr/ADR-NNNN-titulo-kebab-case.md
   ```
