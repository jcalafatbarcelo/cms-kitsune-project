...
| :--- | :--- | :--- | :--- | :--- |
| 1 | Fundación de CMS Templates | Borrador | ADR-0004 aceptado | Base, manifiesto, ciclo de vida local y predeterminado gestionados por Core |
...
El primer paso no está implementado: `SPEC-template-foundation` permanece en
`Borrador` hasta recibir aprobación explícita. La finalización del paso 1 no
autoriza automáticamente el paso 2.
